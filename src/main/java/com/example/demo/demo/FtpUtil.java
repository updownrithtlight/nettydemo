...
public class FtpUtil {
    ...
    public static void main(String[] args) {
        String ftpHost = "192.168.8.109";
        String ftpUserName = "ciySJU";
        String ftpPassword = "z5d68R";
        int ftpPort = 2121;
        String ftpPath = "/Download/";
        String fileName = "shadowsocksr-android-3.5.4.apk";

        //上传一个文件
        try{
            String tmpPath = System.getProperty("java.io.tmpdir");
            FileInputStream in=new FileInputStream(new File("D:\\download\\" + fileName));
